...
contract Halo2Verifier {
    ...
    uint256 internal constant NUM_INSTANCE_CPTR = 0x0504;
    uint256 internal constant     INSTANCE_CPTR = 0x0524;

    uint256 internal constant FIRST_QUOTIENT_X_CPTR = 0x01c4;
    uint256 internal constant  LAST_QUOTIENT_X_CPTR = 0x0284;
    ...
    uint256 internal constant CHALLENGE_MPTR = 0x39c0;

    uint256 internal constant THETA_MPTR = 0x39c0;
    uint256 internal constant  BETA_MPTR = 0x39e0;
    uint256 internal constant GAMMA_MPTR = 0x3a00;
    uint256 internal constant     Y_MPTR = 0x3a20;
    uint256 internal constant     X_MPTR = 0x3a40;
    uint256 internal constant  ZETA_MPTR = 0x3a60;
    uint256 internal constant    NU_MPTR = 0x3a80;
    uint256 internal constant    MU_MPTR = 0x3aa0;

    uint256 internal constant       ACC_LHS_X_MPTR = 0x3ac0;
    uint256 internal constant       ACC_LHS_Y_MPTR = 0x3ae0;
    uint256 internal constant       ACC_RHS_X_MPTR = 0x3b00;
    uint256 internal constant       ACC_RHS_Y_MPTR = 0x3b20;
    uint256 internal constant             X_N_MPTR = 0x3b40;
    uint256 internal constant X_N_MINUS_1_INV_MPTR = 0x3b60;
    uint256 internal constant          L_LAST_MPTR = 0x3b80;
    uint256 internal constant         L_BLIND_MPTR = 0x3ba0;
    uint256 internal constant             L_0_MPTR = 0x3bc0;
    uint256 internal constant   INSTANCE_EVAL_MPTR = 0x3be0;
    uint256 internal constant   QUOTIENT_EVAL_MPTR = 0x3c00;
    uint256 internal constant      QUOTIENT_X_MPTR = 0x3c20;
    uint256 internal constant      QUOTIENT_Y_MPTR = 0x3c40;
    uint256 internal constant       G1_SCALAR_MPTR = 0x3c60;
    uint256 internal constant   PAIRING_LHS_X_MPTR = 0x3c80;
    uint256 internal constant   PAIRING_LHS_Y_MPTR = 0x3ca0;
    uint256 internal constant   PAIRING_RHS_X_MPTR = 0x3cc0;
    uint256 internal constant   PAIRING_RHS_Y_MPTR = 0x3ce0;
    ...
    function verifyProof(
        ...
        assembly {
...

            {
                ...
                success := and(success, eq(0x0480, calldataload(PROOF_LEN_CPTR)))
                ...
                extcodecopy(vk, VK_MPTR, 0x00, 0x36a0)
            ...
            // Compute quotient evavluation
            {
                ...
                let y := mload(Y_MPTR)
                {
                    let f_0 := calldataload(0x0324)
                    let a_0 := calldataload(0x02c4)
                    let var0 := mulmod(f_0, a_0, r)
                    let f_1 := calldataload(0x0344)
                    let a_1 := calldataload(0x02e4)
                    let var1 := mulmod(f_1, a_1, r)
                    let var2 := addmod(var0, var1, r)
                    let f_2 := calldataload(0x0364)
                    let a_2 := calldataload(0x0304)
                    let var3 := mulmod(f_2, a_2, r)
                    let var4 := addmod(var2, var3, r)
                    let f_3 := calldataload(0x0384)
                    let var5 := mulmod(f_3, a_0, r)
                    let var6 := mulmod(var5, a_1, r)
                    let var7 := addmod(var4, var6, r)
                    let f_4 := calldataload(0x03a4)
                ...
                {
                    let perm_z_last := calldataload(0x0444)
                ...
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0304), mulmod(beta, calldataload(0x0424), r), r), gamma, r), r)
            ...
            // Compute pairing lhs and rhs
            {
                ...
                }
                {
                    ...
                    let r_eval
                    r_eval := mulmod(coeff, calldataload(0x03c4), r)
                ...
                }
                {
                    ...
                    mstore(0x00, calldataload(0x0184))
                    mstore(0x20, calldataload(0x01a4))
                    ...
                    mstore(0x80, calldataload(0x0144))
                    mstore(0xa0, calldataload(0x0164))
                    ...
                    success := ec_add_acc(success, mload(0x80), mload(0xa0))
                    mstore(0x80, calldataload(0x04c4))
                    mstore(0xa0, calldataload(0x04e4))
                    success := ec_mul_tmp(success, mload(MU_MPTR))
                    success := ec_add_acc(success, mload(0x80), mload(0xa0))
                    mstore(PAIRING_LHS_X_MPTR, mload(0x00))
                    mstore(PAIRING_LHS_Y_MPTR, mload(0x20))
                    mstore(PAIRING_RHS_X_MPTR, calldataload(0x04c4))
                    mstore(PAIRING_RHS_Y_MPTR, calldataload(0x04e4))
                }
            }
