...
contract FflonkVerifier {
    ...
    uint256 constant C0x  = 18745031950063119253028435248486296006046828946542239696993304137931310380733;
    uint256 constant C0y  = 10035274274647316128858742435456755407266378467207294042388021561445710575780;
    ...
    function callVerifyProof(bytes32[24] calldata proof, uint256[2] calldata pubSignals) public returns (bool) {
